                                     ...
                                     com.genexus.xml.XMLReader oReader )
   {
      ...
      if ( oReader.getErrCode() == 0 )
      {
         if ( oReader.readType((short)(1), "GXLocations") > 0 )
         {
            ...
            while ( ( currError > 0 ) && ! ( ( GXutil.strcmp(oReader.getName(), "GXLocations") == 0 ) && ( oReader.getNodeType() == 2 ) ) )
            {
               if ( ( GXutil.strcmp(oReader.getName(), "GXLocation") == 0 ) && ( oReader.getNodeType() == 1 ) )
               {
                  ...
                  nFirstRead = (byte)(1) ;
                  currError = oReader.read() ;
                  while ( ( currError > 0 ) && ! ( ( GXutil.strcmp(oReader.getName(), "GXLocation") == 0 ) && ( oReader.getNodeType() == 2 ) ) )
                  {
