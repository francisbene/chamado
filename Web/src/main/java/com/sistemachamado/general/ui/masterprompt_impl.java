...
public final  class masterprompt_impl extends GXMasterPage
{
   public masterprompt_impl( com.genexus.internet.HttpContext context )
   {
      super(context);
   }

   public masterprompt_impl( int remoteHandle )
   {
      super( remoteHandle , new ModelContext( masterprompt_impl.class ));
   }
   ...
   public void renderHtmlCloseForm022( )
   {
      ...
      httpContext.AddJavascriptSource("general/ui/masterprompt.js", "?2024112910345062", false, true);
   ...
   public void wb020( )
   {
      ...
      if ( ! wbLoad )
      {
         ...
         /* Div Control */
         com.sistemachamado.GxWebStd.gx_div_start( httpContext, divMaintable_Internalname, 1, 0, "px", 0, "px", "ContainerFluid PromptMainTable", "start", "top", "", "", "div");
         /* Div Control */
   ...
   public void define_styles( )
   {
      ...
      {
         httpContext.AddJavascriptSource(GXutil.rtrim( (getDataAreaObject() == null ? Form : getDataAreaObject().getForm()).getJscriptsrc().item(idxLst)), "?2024112910345063", true, true);
         idxLst = (int)(idxLst+1) ;
      }
      if ( ! outputEnabled )
      {
   ...
   public void include_jscripts( )
   {
      if ( nGXWrapped != 1 )
      {
         httpContext.AddJavascriptSource("general/ui/masterprompt.js", "?2024112910345063", false, true);
      }
